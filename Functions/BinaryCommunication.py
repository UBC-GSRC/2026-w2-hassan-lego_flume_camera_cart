...
#defines function cart and sets first input to be the IP address, second input to be the port used
    ...
    def read_outputs(self):
        self.s.send(bytearray.fromhex('12'))
    ...
    def setBit2(self, axis:Axis, bitNumber:int):
        lo_hi = bitNumber.to_bytes(2, 'little')

        param_bytes = lo_hi + b"\x00"
    ...
    def clearBit(self, axis:Axis, bitNumber:int):
        lo_hi = bitNumber.to_bytes(2, 'little')
